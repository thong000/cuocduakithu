...
class Store:
    def __init__ (self, lan, wnd_width, wnd_height):
        ...
        self.potion1 = Button(self.potion1_img, wnd_width // 7 * 2, wnd_height // 16 * 3, wnd_width // 15, wnd_height // 5)
        self.potion2 = Button(self.potion2_img, wnd_width // 7 * 2, wnd_height // 32 * 15, wnd_width // 15, wnd_height // 5)
        self.potion3 = Button(self.potion3_img, wnd_width // 7 * 2, wnd_height // 16 * 12, wnd_width // 15, wnd_height // 5)
        self.close   = Button(self.close_img, wnd_width // 20 * 19, wnd_height // 20 * 1, wnd_width // 192 * 10, wnd_height // 108 * 10)
        self.buy     = Button(self.buy_img, wnd_width // 7 * 2, wnd_height // 16 * 15, wnd_width // 17, wnd_height // 17)
        self.p1_desc = Button(self.p1_desc_img, wnd_width // 32 * 19, wnd_height // 14 * 9, wnd_width // 4, wnd_height // 16 * 7)
        self.p2_desc = Button(self.p2_desc_img, wnd_width // 32 * 19, wnd_height // 14 * 9, wnd_width // 4, wnd_height // 16 * 7)
        self.p3_desc = Button(self.p3_desc_img, wnd_width // 32 * 19, wnd_height // 14 * 9, wnd_width // 4, wnd_height // 16 * 7)
    ...
    def running(self, surface, money, wnd_width, wnd_height):
        ...
        while run:
            ...
            if check_press(self.buy.image_rect, mouse_pos):
                if k1 and self.buy1 and money >= 20:
                    self.buy1 = False
                    money -= 20
                    buff += 0.1
                elif k2 and self.buy2 and money >= 35:
                    self.buy2 = False
                    money -= 35
                    buff += 0.2
                elif k3 and self.buy3 and money >= 45:
                    self.buy3 = False 
                    money -= 45
                    buff += 0.3
