...
class Flappy_bird:
    ...
    def Flappy_bird_game(self, screen):
        clock.tick(120)
...
bg = pygame.transform.scale(pygame.image.load(r'Flappy_Bird\menugame.png'), (1400, 800))
bird_game = True
while True:

    if not bird.check_change_screen:
        screen = pygame.display.set_mode((500, 768))
        bird.check_change_screen = True
    bird.Flappy_bird_game(screen)
